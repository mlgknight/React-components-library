...
export default function Tooltip(props: TooltipProps) {
	const { children, color, colorType, header_text, className = '', ...rest } = props;
	let colorClass;
	...
	const dynamicStyle = [
		{
			borderTopColor: color ? `var(--${color})` : '#FFFFFF',
		},
		{
			color: color ? `var(--${colorType === "dark" ? "bg_dark_" + color : "bg_" + color})` : '#FFFFFF',
		},
	];
